...
void kalman1_init(kalman1_state *state, float init_x, float init_p, float init_q, float init_r)
{
    ...
    state->A = 1;
    state->H = 1;
    state->q = init_q;//0.1;//10e-6;  /* predict noise convariance */
    state->r = init_r;//800;//10e-5;  /* measure error convariance */
}

//void kalman1_gyro_int(kalman1_state *state, float init_x, float init_p)
//{
//    
//}
